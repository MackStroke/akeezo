            ...
            <div className="p-4 sm:p-7 border-b border-dashed border-[#e0dad0] dark:border-white/10 bg-[#f4f1e8] dark:bg-white/5">
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                ...
                <div className="flex items-start gap-3">
                  <div className="flex size-11 shrink-0 items-center justify-center rounded-xl bg-black text-white shadow-sm border border-black/20">
                    <FileText className="size-6 text-white" />
                  </div>
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="font-mono text-[0.65rem] font-black text-white uppercase tracking-widest bg-black px-2.5 py-0.5 rounded shadow-xs">
                    ...
                    <p className="text-[0.72rem] sm:text-xs text-slate-700 dark:text-slate-300 font-sans font-medium">
                ...
                <div className="sm:text-right font-mono text-xs bg-[#eae5db] dark:bg-white/10 text-slate-800 dark:text-slate-200 p-2.5 rounded-md border border-[#ded8cb] dark:border-white/10 shadow-sm shrink-0">
                  <div className="text-[0.65rem] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">Estimate Ref</div>
                  <div className="font-extrabold text-slate-900 dark:text-white text-sm">EST-2026-8849</div>
                  <div className="text-[0.65rem] text-slate-600 dark:text-slate-400 mt-0.5">Date: {new Date().toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</div>
                </div>
              </div>
              ...
              <div className="mt-5 grid grid-cols-2 sm:grid-cols-4 gap-2.5 pt-4 border-t border-dashed border-[#e0dad0] dark:border-white/10 text-xs font-sans">
                <div className="rounded bg-[#eae5db] dark:bg-white/10 p-2 border border-[#ded8cb] dark:border-white/10">
                  <span className="text-[0.65rem] font-bold uppercase tracking-wider text-slate-600 dark:text-slate-400 block">Patient Case</span>
                  <span className="font-extrabold text-slate-900 dark:text-white block mt-0.5 text-xs truncate">International Patient</span>
                </div>
                <div className="rounded bg-[#eae5db] dark:bg-white/10 p-2 border border-[#ded8cb] dark:border-white/10">
                  <span className="text-[0.65rem] font-bold uppercase tracking-wider text-slate-600 dark:text-slate-400 block">Procedure</span>
                  <span className="font-extrabold text-slate-900 dark:text-white block mt-0.5 text-xs truncate">Coronary Angioplasty</span>
                </div>
                <div className="rounded bg-[#eae5db] dark:bg-white/10 p-2 border border-[#ded8cb] dark:border-white/10">
                  <span className="text-[0.65rem] font-bold uppercase tracking-wider text-slate-600 dark:text-slate-400 block">Est. Duration</span>
                  <span className="font-extrabold text-slate-900 dark:text-white block mt-0.5 text-xs truncate">18–21 Days (2 Pax)</span>
                </div>
                <div className="rounded bg-[#eae5db] dark:bg-white/10 p-2 border border-[#ded8cb] dark:border-white/10">
                  <span className="text-[0.65rem] font-bold uppercase tracking-wider text-slate-600 dark:text-slate-400 block">Currency</span>
                  <span className="font-extrabold text-slate-900 dark:text-white block mt-0.5 text-xs truncate">{currency.code} ({currency.symbol})</span>
                </div>
              </div>
            </div>
