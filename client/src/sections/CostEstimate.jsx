...
export function CostEstimate() {
  ...
  return (
    <section id="cost" aria-labelledby="cost-heading" className="py-16 bg-background">
      <div className="mx-auto grid max-w-[76rem] items-start gap-10 px-4 lg:grid-cols-12">
        ...
        <div className="lg:col-span-5 flex flex-col justify-center">
          ...
          <h2
            id="cost-heading"
            className="mt-3 text-2xl sm:text-[2rem] font-black tracking-tight text-ink-strong leading-tight"
          >
          ...
          <ul className="mt-6 flex flex-col gap-3">
            {ASSURANCES.map((a) => (
              <li key={a} className="flex items-start gap-3 text-sm text-foreground font-medium">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <Button asChild size="lg" className="cta-gradient font-bold text-white shadow-md rounded-full px-8">
          ...
          <div className="mt-8 relative overflow-hidden rounded-[var(--radius)] border border-rule bg-card shadow-card group">
            <img
        ...
        <div className="lg:col-span-7">
          <div className="relative overflow-hidden rounded-[1.25rem] border border-rule bg-card shadow-[0_8px_30px_rgb(29_38_93/0.12)]">
            {/* Bill Header Strip */}
            <div className="border-b border-rule bg-navy p-6 text-white relative">
              <div className="flex flex-wrap items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  <div className="flex size-10 items-center justify-center rounded-xl bg-white/10 backdrop-blur-md text-primary-foreground border border-white/15">
                    <FileText className="size-5 text-primary" />
                  </div>
                  <div>
                    <div className="flex items-center gap-2">
                      <h3 className="text-lg font-black tracking-tight text-white">AKEEZO MEDICAL BILL ESTIMATE</h3>
                      <Badge className="bg-emerald-500/20 text-emerald-300 border-emerald-500/30 text-[0.65rem] uppercase tracking-wider font-extrabold">
                        Verified Quote
                      </Badge>
                    </div>
                    <p className="text-xs text-white/70 mt-0.5">
                      Ref: <span className="font-mono text-white/90 font-bold">EST-2026-8849</span> · Issued for Medical Journey Planning
                    </p>
                  </div>
                </div>

                <div className="text-right">
                  <span className="block text-[0.68rem] font-bold text-white/60 uppercase tracking-wider">Estimated Total</span>
              ...
              <div className="mt-5 grid grid-cols-2 sm:grid-cols-4 gap-2.5 text-xs border-t border-white/10 pt-4">
                <div className="rounded-lg bg-white/5 p-2.5 border border-white/10">
                  <span className="text-white/60 block text-[0.68rem]">Procedure</span>
                  <span className="font-bold text-white truncate block mt-0.5">Coronary Angioplasty</span>
                </div>
                <div className="rounded-lg bg-white/5 p-2.5 border border-white/10">
                  <span className="text-white/60 block text-[0.68rem]">Destination</span>
                  <span className="font-bold text-white truncate block mt-0.5">Delhi NCR, India</span>
                </div>
                <div className="rounded-lg bg-white/5 p-2.5 border border-white/10">
                  <span className="text-white/60 block text-[0.68rem]">Duration & Travelers</span>
                  <span className="font-bold text-white truncate block mt-0.5">18–21 Days (2 Pax)</span>
                </div>
                <div className="rounded-lg bg-white/5 p-2.5 border border-white/10">
                  <span className="text-white/60 block text-[0.68rem]">Display Currency</span>
                  <span className="font-bold text-primary truncate block mt-0.5">{currency.code} ({currency.symbol})</span>
                </div>
              </div>
            </div>
            ...
            <div className="overflow-x-auto p-4 sm:p-6">
              ...
              <div className="mt-6 rounded-xl border border-primary/20 bg-secondary/50 p-4 sm:p-5">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center justify-between text-xs text-emerald-600 font-semibold">
                    <span className="flex items-center gap-1 font-bold">
                      <ShieldCheck className="size-3.5" /> AKEEZO Transparency & Coordination Fee
                    </span>
                    <span className="font-bold">Included (₹0 hidden fees)</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <span className="text-base font-black text-ink-strong block">ESTIMATED JOURNEY TOTAL</span>
              ...
              <div className="mt-4 flex flex-wrap items-center justify-between gap-3 text-[0.72rem] text-muted-foreground border-t border-rule pt-4">
                <div className="flex items-center gap-2">
